...
nnoremap <silent> <F6> :let s_=@/|:%s/\s\+$//e|:let @/=_s|:nohl
...
exe 'vert 1resize ' . ((&columns * 213 + 213) / 427)
exe 'vert 2resize ' . ((&columns * 213 + 213) / 427)
argglobal
enew
